        ...
        <div className="w-full md:w-1/2 flex flex-col gap-2 mt-3">
          {skills.map((data, index) => {
            ...
            >
              ...
              <span className={`absolute inset-0 bg-[#1D1D21] rounded-full transform ${index%2===0? 'scale-x-0 origin-left':'scale-y-0 origin-bottom'}    group-hover:${index%2===0? 'scale-x-100 origin-right duration-400':'scale-y-100 origin-top'} transition-transform duration-300 ease-out`}></span>
            </div>
